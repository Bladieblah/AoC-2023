...
fn traverse(grid: &Vec<&[u8]>, pos: (usize, usize, usize), size: usize, visited: &mut HashSet<(usize, usize, usize)>, paths: &HashMap<(usize, usize, usize), ((usize, usize, usize), Vec<(usize,usize, usize)>)>) {
...
fn find_next_split(grid: &Vec<&[u8]>, pos: (usize, usize, usize), size: usize, visited: &mut Vec<(usize, usize, usize)>) -> (usize, usize, usize) {
...
fn main(input: &str) -> (usize, usize) {
  ...
  let mut paths = HashMap::<(usize, usize, usize), ((usize, usize, usize), Vec<(usize,usize,usize)>)>::new();
